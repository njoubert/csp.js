...
require(["csp"], function (csp) {
  ...
  for (var ri in rows) {
    ...
    p.addConstraint(rowels, function (a, b, c, d, e, f, g, h, i) {
      return (
        (a === 1 ||
          b === 1 ||
          c === 1 ||
  ...
  for (var ci in cols) {
    ...
    p.addConstraint(colels, function (a, b, c, d, e, f, g, h, i) {
      return (
        (a === 1 ||
          b === 1 ||
          c === 1 ||
  ...
  var constrainBlock = function (top_i, left_i) {
    ...
    p.addConstraint(els, function (a, b, c, d, e, f, g, h, i) {
      return (
        (a === 1 ||
          b === 1 ||
          c === 1 ||
  ...
  document.getElementById("constraints").innerHTML = p.constraints.reduce(
    function (pV, cV, i, a) {
      return pV + cV + "<br/>";
    },
    ""
